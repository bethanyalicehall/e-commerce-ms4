    ...
    if size:
        if item_id in list(bag.keys()):
            if size in bag[item_id]['items_by_size'].keys():
                ...
                messages.success(request, f'{product.name} size {size.upper()} quantity has been updated to {bag[item_id]["items_by_size"][size]}')
            else:
                bag[item_id]['items_by_size'][size] = quantity
        ...
        if item_id in list(bag.keys()):
            ...
            messages.success(request, f'{product.name} quantity has been updated to {bag[item_id]}')
        else:
            bag[item_id] = quantity
